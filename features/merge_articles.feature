...
| 2 | user_1 | User1 | abcdefg | foo@example.com | active |
| 3 | user_2 | User2 | abcdefg | bar@example.com | active |

Given the following articles exist:
| id | title | author | user_id | body | allow_comments | published | published_at | state | type |
| 3 | Article1 | user_1 | 2 | Content1 | true | true | 2013-01-11 21:30:00 | published | Article |
| 4 | Article2 | user_2 | 3 | Content2 | true | true | 2013-20-10 22:00:00 | published | Article |

Given the following comments exist:
| id | type | author | body | article_id | user_id | created_at |
| 1 | Comment | user_1 | Comment1 | 3 | 2 | 2013-02-11 18:11:00 |
| 2 | Comment | user_1 | Comment2 | 4 | 2 | 2013-30-10 13:33:00 |

Scenario: A non-admin cannot merge articles
Given I am logged in as "user_1" with pass "abcdefg"
